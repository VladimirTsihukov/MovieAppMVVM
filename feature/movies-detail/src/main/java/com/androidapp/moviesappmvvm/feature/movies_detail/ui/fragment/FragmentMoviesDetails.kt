package com.androidapp.moviesappmvvm.feature.movies_detail.ui.fragment
...
import com.androidapp.moviesappmvvm.feature.movies_detail.di.MovieDetailsComponent
import com.androidapp.moviesappmvvm.feature.movies_detail.di.movieDetailsComponent
import com.androidapp.moviesappmvvm.feature.movies_detail.ui.adapter.AdapterActors
...
class FragmentMoviesDetails : Fragment(R.layout.fragment_movies_details) {
    ...
    private val component: MovieDetailsComponent by lazy {
    ...
    private fun getViewModel(): ViewModelMovieDetails {
        return component.let {
            ViewModelProvider(this, customViewModelFactory(it))[ViewModelMovieDetails::class.java]
        }
    }
